...
def store_results_in_mongo(user_name, score, total_questions):
    result = {
        "user_name": user_name,
        "score": score,
...
def main():
    ...
    if "questions" not in st.session_state:
        st.title("🔖 Upload PDF to generate a customized quiz!")
    ...
    # MCQ page
        ...
        if st.session_state.get("submitted", False):
            ...
            # Ask for user name
            # user_name = st.text_input("Enter your name for storing results:")

            # Store results in MongoDB if user name is provided
            user_name = "ritu"
            store_results_in_mongo(user_name, score, len(attempted_questions))
            st.write("Results stored successfully in MongoDB!")
